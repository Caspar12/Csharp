...
{
	#region CarMainItemEngineDto

	/// <summary>
    /// 车辆发动机参数
	/// CarMainItemEngineDto data view model for mapped table 'Car_MainItem_Engine'.
	/// </summary>
	public partial class CarMainItemEngineDto
	{
		
		#region Constructors
        
		public CarMainItemEngineDto() { }        
