...
{
    public partial class RepairSetTodtFeedbackService : GenericContextService<RepairSetTodtFeedbackDto,Repair_SetTodt_Feedback >,IRepairSetTodtFeedbackService
    {
