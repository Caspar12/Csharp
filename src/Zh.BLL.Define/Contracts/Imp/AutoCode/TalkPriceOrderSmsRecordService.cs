...
{
    public partial class TalkPriceOrderSmsRecordService : GenericContextService<TalkPriceOrderSmsRecordDto,TalkPrice_OrderSmsRecord >,ITalkPriceOrderSmsRecordService
    {
