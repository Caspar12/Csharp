...
{
    public partial class MemberEmailUpdateHistoryService : GenericContextService<MemberEmailUpdateHistoryDto,Member_EmailUpdateHistory >,IMemberEmailUpdateHistoryService
    {
