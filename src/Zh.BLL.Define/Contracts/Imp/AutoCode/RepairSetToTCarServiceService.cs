...
{
    public partial class RepairSetToTCarServiceService : GenericContextService<RepairSetToTCarServiceDto,Repair_SetToT_CarService >,IRepairSetToTCarServiceService
    {
