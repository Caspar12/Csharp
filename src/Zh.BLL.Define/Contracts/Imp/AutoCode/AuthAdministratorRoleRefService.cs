...
{
    public partial class AuthAdministratorRoleRefService : GenericContextService<AuthAdministratorRoleRefDto,Auth_AdministratorRoleRef >,IAuthAdministratorRoleRefService
    {
