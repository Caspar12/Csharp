...
{
    public partial class AuthPermissionResourceRefService : GenericContextService<AuthPermissionResourceRefDto,Auth_PermissionResourceRef >,IAuthPermissionResourceRefService
    {
