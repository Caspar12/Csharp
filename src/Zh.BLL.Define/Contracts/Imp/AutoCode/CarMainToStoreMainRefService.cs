...
{
    public partial class CarMainToStoreMainRefService : GenericContextService<CarMainToStoreMainRefDto,Car_MainToStore_MainRef >,ICarMainToStoreMainRefService
    {
